      ...
      return {
        data: [{
          ...
          attributes: {
            ...
            description: 'Developed in 2016 for back-end programming course at JAMK University of Applied Sciences, this website allows users to search League of Legends players based on their' + ' server and username. Utilizes the official API from Riot Games, it has MySQL database for storing static game data and recent games from searched players, and it has a simple admin' + ' panel for updating the database manually. Written in plain PHP, HTML5, CSS3 and MySQL.',
...
if (!runningTests) {
  require("portfolio/app")["default"].create({"name":"portfolio","version":"0.0.0+8d1679d7"});
}
