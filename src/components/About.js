    ...
    return (
      <div className="row">
        <div className="twelve columns">
          ...
          <p>I'm Vesa Kivistö, a web developer ready to conquer the world. I have experience in full-stack development, and lately I have gained interest in mobile development
            and artificial intelligence as well. I'm always looking forward to learning something new.</p>
